...
export default function Home() {
  return (
    <main className="min-h-screen bg-[color:var(--background)] text-[color:var(--foreground)]">
      ...
      <section
        id="about"
        className="px-6 md:px-20 py-16 flex flex-col md:flex-row items-center gap-12"
      >
        {/* Profile Image */}
        <div className="w-full md:w-1/3">
          <div className="aspect-square bg-white/10 rounded-full border border-[color:var(--border)] overflow-hidden">
            <img
              src="/profile_pic.png"
              alt="Nilesh's profile"
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <p className="text-lg text-[color:var(--secondary)] leading-relaxed">
            I build fast, scalable full-stack apps with expressive UIs,
            intelligent backends, and a developer-first approach. Currently
            shipping projects using React, Next.js, MongoDB, and Express.
          </p>
          <Link
            href="/projects"
      ...
      <section
        id="projects"
        className="px-6 md:px-20 py-24 max-w-6xl mx-auto text-center"
      >
        <h2 className="text-3xl md:text-4xl font-bold mb-12">Recent Projects</h2>
      ...
      {/* Why I Code Section */}
      <section className="px-6 md:px-20 py-24 max-w-3xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6">Why I Code</h2>
        <p className="text-lg text-[color:var(--secondary)] leading-relaxed">
          I love solving real problems with code. My mission is to craft digital
          tools that make people think, “Wow, that&apos;s smooth.” I care about
          performance, pixel-perfection, and empowering people through tech.
        </p>
      </section>
      ...
      <section
        id="contact"
        className="px-6 md:px-20 py-24 text-center bg-[color:var(--universal-nav-background)]"
      >
